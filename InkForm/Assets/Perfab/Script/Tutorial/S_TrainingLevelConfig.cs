...
public enum S_TrainingIntroMode
{
    None,
    TeachAndPractice,
    PracticeOnly
...
[CreateAssetMenu(fileName = "TrainingLevelConfig", menuName = "InkForm/Level Flow/Training Level Config")]
public class S_TrainingLevelConfig : ScriptableObject
{
    [Header("Tutorial")]
    [Tooltip("TeachAndPractice = show voice + prompt + wait for input. PracticeOnly = skip to camera pan + countdown.")]
    public S_TrainingIntroMode tutorialType = S_TrainingIntroMode.None;
    ...
    [Header("Authoring Notes")]
    [Tooltip("Optional label for designers. The run flow is controlled by S_RunFlowConfig, not by this flag.")]
